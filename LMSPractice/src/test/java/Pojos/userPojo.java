...
public class userPojo {
    ...
    BatchPojo userAddress;

	public userPojo() {
    	
    }
    
    public userPojo(String fname,String lname,String number,String email,BatchPojo address) {
    ...
    public BatchPojo getUserAddress() {
		return userAddress;
	}

	public void setUserAddress(BatchPojo userAddress) {
